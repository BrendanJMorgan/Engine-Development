...
vdot_fuel = mdot_fuel/density_fuel; %m3/s - Fuel Volumetric Flow Rate
vdot_ox = mdot_ox/density_ox; %m3/s - Oxidizer Mass Flow Rate

%% Inputs

r_pump = 2*0.0254; % m - blade radius
h_exit_pump = 0.5*0.0254; % m - exit gap height

pump_eff = 0.2;
blade_angle = 20*pi/180;
...
power_fuel = mdot_fuel*9.80665*head_fuel/pump_eff; % W
power_ox = mdot_ox*9.80665*head_ox/pump_eff; % W