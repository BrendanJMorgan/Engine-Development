...
while abs(error) > 0.01
    ...
    power_turbine = turbine_shaft_power/stage_efficiency; % W
...
% blade_length_rotor = sqrt(4*r_rotor_pitchline*mdot_gg/(blade_number_rotor*blade_gap_rotor*sec(blade_angle_rotor)*dens_gas_spouted*v_spouting(2))); % m - blades are unshrouded
...
rotor_density = 7850; % kg/m3
rotor_poissons = 0.303; % unitless
% rotor_density = 4506; % kg/m3
% rotor_poissons = 0.31; % unitless
