...
wheel_ratio = v_axial_rotor / norm(v_spouting); % unitless - ration between outlet/inlet velocity of blades. Must be absolute, because the relative ratio would always be 1?
