...
function length = film_cooled_length(mdot_film, T_film, Prandtl, viscosity, d_avg, l_chamber, dens_gas, v_gas, T_gas, H_gas, p_gas, cp_gas, mol_gas)
    ...
    H_gas_stag = H_gas + v_gas.^2/2; % J - stagnation enthalpy of combustion gas
    ...
    X = (dens_gas)^0.5 * v_gas * (T_gas/T_interface)^0.25 / surface_tension; % 1/N^0.5 - liquid entrainment correlation parameter CHECK IF THERE SHOULD BE A G
    ...
    V = pi*d_avg*dens_gas*v_gas*Stanton*B*a; % kg/m*s - surface vaporization rate
